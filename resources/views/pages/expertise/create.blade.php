                        ...
                        <div class="uk-grid uk-grid-width-1-2">
                            ...
                            <div>
                                ...
                                <div class="uk-margin-top expertise-extra-fields" id="expertise-user-fullname">
                                    ...
                                    <div class="uk-form-controls uk-margin-small-top">
                                        <input type="text" placeholder="ФИО лица назначевшего экспертизу" class="uk-width-1-1{{ $errors->has('expertise_user_fullname') ? ' uk-form-danger' : '' }}" name="expertise_user_fullname" value="{{ old('expertise_user_fullname') }}">
                                    </div>
                                </div>
                                ...
                                <div class="uk-margin-top expertise-extra-fields" id="expertise-user-position">
                                    ...
                                    <div class="uk-form-controls uk-margin-small-top">
                                        <input type="text" placeholder="Должность лица назначевшего экспертизу" class="uk-width-1-1{{ $errors->has('expertise_user_position') ? ' uk-form-danger' : '' }}" name="expertise_user_position" value="{{ old('expertise_user_position') }}">
                                    </div>
                                </div>
                                <div class="uk-margin-top expertise-extra-fields" id="expertise-user-rank">
                                    ...
                                    <div class="uk-form-controls uk-margin-small-top">
                                        <select class="uk-width-1-1" name="expertise_user_rank">
                                            <option value="" {{ (old('expertise_user_rank') == '') ? 'selected' : '' }} disabled>Выберите звание лица назначевшего экспертизу</option>
