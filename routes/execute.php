	...
	<div id="main-content">
		<div class="col-lg-12" style="border-bottom: 1px solid #ccc; padding-top:20px; padding-bottom:20px;">
			...
			<div class="col-lg-6" style="padding-top:5px;">
				...
				<div class="col-lg-5" id="plot_block" style="min-height:45px;height:auto; max-height: 100%;">
					<strong>Фабула:</strong>
				</div>
				<div class="col-lg-7" id="plot_value" style="min-height:45px; height:auto; max-height: 100%;">
					<?=$expertise['plot'];?>
				</div>
				<div class="col-lg-5">
...
<script>
	$(document).ready(function(){
		var height = $('#plot_value').css('height');
		$("#plot_block").css('height', height);
		var x = 0;
		...
		$('#pause_reason_id_'+reason_counter).on('change', function(){
				...
				if(pause_reason_id!='0'){
					...
					$('.pause_reason_basis_wrapper_'+reason_counter).hide();
					$('#renewal_date_wrapper_'+reason_counter).hide();
					$('#form').remove();
					$('#save_'+reason_counter).hide();
					$('#choose_btn').remove();
				}
